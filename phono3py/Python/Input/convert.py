...
# Loop through files supercell-00001.in to supercell-00100.in
for i in range(1, 101):
    # Define the input and output filenames with zero-padded numbers
    input_file = os.path.join(current_dir, f'supercell-{i:05d}.in')
    output_file = os.path.join(current_dir, f'coord-{i:05d}.in')
